...
import llm_gatewayV3.db as db
import llm_gatewayV3.providers as P
from llm_gatewayV3.router import Router, RouterPool, DEFAULT_ROUTER_ORDER, LIMITS, SHORTCUTS, resolve
from llm_gatewayV3.cache import GeminiCache
from llm_gatewayV3.schemas import ChatRequest, ChatResponse, ToolCall, RouterDecision

# DEFAULT_ORDER = ["ollama", "gemini", "nvidia", "groq", "cerebras", "openrouter", "github"]
# Updated: Gemini first (large context), Cerebras second (60K TPM free), Groq third,
# then NVIDIA/OpenRouter/GitHub as additional free tiers, Ollama as local last resort
DEFAULT_ORDER = ["gemini", "cerebras", "groq", "nvidia", "openrouter", "github", "ollama"]
...
TIER_TO_ORDER = {
    "TINY":  ["cerebras", "github", "groq", "openrouter", "nvidia", "gemini", "ollama"],
    "LARGE": ["gemini", "cerebras", "groq", "nvidia", "openrouter", "github", "ollama"],
}
